...
public class CustomAlertDialog {
    ...
    public static class Builder {
        ...
        private boolean isAlligmentLeft;
         ...
         * Set the message to display.
         *
         * @param alignmentLeft the message
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setMsgAllignmentLeft(@Nullable final boolean alignmentLeft) {
            isAlligmentLeft = alignmentLeft;
            return this;
        }
         ...
         * {@link #setOnCancelListener(DialogInterface.OnCancelListener)
