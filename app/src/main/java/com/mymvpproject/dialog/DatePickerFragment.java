...
public class DatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    private static long mMinDate, mMaxDate;
     ...
     * @return fragment
     */
    public static DatePickerFragment newInstance(final long minDate, final long maxDate, final DatePickerDialog.OnDateSetListener listener) {
        DatePickerFragment fragment = new DatePickerFragment();
        fragment.listener = listener;
        mMinDate = minDate;
        mMaxDate = maxDate;
